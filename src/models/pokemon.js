    ...
    return sequelize.define('Pokemon', {
      ...
      name: {
        ...
        validate: {
          ...
          len: {
            args: [1, 25],
            msg: 'Le nom doit être compris entre 1 et 25 caractères.'
          }
        }
      },
      hp: {
        ...
        validate: {
          ...
          max: {
            args: [999],
            msg: 'Les points de vie doivent être inféreurs ou égal à 999.'
          }
        }
      },
      cp: {
        ...
        validate: {
          ...
          min: {
            args: [0],
            msg: 'Les points de dégats doivent être supérieur ou égal à 0.'
          },
          max: {
            args: [99],
            msg: 'Les points de dégats doivent être inféreurs ou égal à 99.'
          }
        }
      },
      picture: {
